...
interface IconBoxProps {
  icon: LucideIcon
  color?: IconBoxColor
  variant?: "solid" | "outline-solid" | "subtle" | "ghost"
  size?: "sm" | "md" | "lg" | "xl"
  className?: string
  onClick?: () => void
}

const colorClasses: Record<IconBoxColor, Record<"solid" | "outline" | "subtle" | "ghost", string>> = {
  blue: {
...
export function IconBox({
  ...
  return (
    <Component
      onClick={onClick}
      className={cn(
        "inline-flex items-center justify-center rounded-lg backdrop-blur-sm",
